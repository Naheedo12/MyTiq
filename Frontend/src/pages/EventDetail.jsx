        ...
        <div className="bg-white shadow-md rounded-lg p-6 h-fit w-full lg:w-2/5">
          ...
          <div className="flex items-start gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm">
                Greenfield Park, Central City <br />
                <a href="#" className="text-[#40916C] underline text-sm">
                  View on map
                </a>
              </p>
            </div>
          ...
          <p className="text-3xl font-bold mb-6">$79.99</p>
